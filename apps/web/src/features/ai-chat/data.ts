...
export const mockConversations: Conversation[] = [
  ...
  // Yesterday
  {
    ...
    model: "claude-opus",
    preview:
      "اولویت‌بندی قابلیت‌های سه‌ماهه اول ۲۰۲۵ بر اساس داده‌های بازخورد کاربر…",
    createdAt: d(1),
    updatedAt: d(1),
    pinned: false,
    archived: false,
  ...
  // Last 7 Days
  {
    ...
    model: "gemini-2-5-pro",
    preview:
      "خوشه‌بندی K-means روی ۵۰ هزار کاربر، ۶ پرسونای متمایز را نشان داد…",
    createdAt: d(3),
    updatedAt: d(3),
    pinned: false,
    archived: false,
...
export const mockMessages: Record<string, Message[]> = {
  "today-1": [
      ...
      thinkingSteps: [
        {
          id: "t1",
          content:
            "تحلیل الگوهای معماری چندمستأجری: اسکیمای مشترک در برابر اسکیما به‌ازای هر مستأجر در برابر پایگاه داده به‌ازای هر مستأجر",
        },
        {
          id: "t2",
          content:
            "ارزیابی ویژگی‌های عملکرد امنیت سطح ردیف (RLS) در مقیاس بزرگ با PostgreSQL",
        },
        {
          id: "t3",
          content: "بررسی استخر اتصال با PgBouncer برای هزاران مستأجر همزمان",
        },
        {
          id: "t4",
          content:
            "پیش‌نویس استراتژی ایندکس‌گذاری برای ستون‌های کلید خارجی `organization_id`",
        },
      ],
      createdAt: h(1.4),
    },
    {
      ...
      role: "user",
      content:
        "می‌توانی اسکیمای واقعی PostgreSQL را به همراه سیاست‌های RLS و ایندکس‌های مناسب بنویسی؟",
      type: "text",
      createdAt: h(1.2),
    },
    {
      ...
      role: "assistant",
      content:
        "این یک اسکیمای PostgreSQL آماده تولید همراه با سیاست‌های RLS است:",
      type: "code",
      codeContent: {
        language: "sql",
        filename: "schema.sql",
...
CREATE TRIGGER organizations_updated_at
  ...
  FOR EACH ROW EXECUTE FUNCTION set_updated_at();`,
    ...
    },
    {
      ...
      role: "user",
      content:
        "عالی! می‌توانی این سه استراتژی چندمستأجری را در یک جدول مقایسه کنی؟",
      type: "text",
      createdAt: h(0.8),
    },
    {
      ...
      tableContent: {
        ...
        rows: [
          {
            feature: "هزینه زیرساخت",
            shared: "کم",
            schemaPer: "متوسط",
            dbPer: "زیاد",
          },
          {
            feature: "جداسازی داده",
            shared: "خوب (RLS)",
            schemaPer: "قوی",
            dbPer: "کامل",
          },
          {
            feature: "حداکثر مستأجر",
            shared: "نامحدود",
            schemaPer: "~۱٬۰۰۰",
            dbPer: "~۱۰۰",
          },
          {
            feature: "پیچیدگی مهاجرت",
            shared: "کم",
            schemaPer: "متوسط",
            dbPer: "زیاد",
          },
          {
            feature: "عملکرد کوئری",
            shared: "خوب با ایندکس",
            schemaPer: "عالی",
            dbPer: "عالی",
          },
          {
          ...
          {
            feature: "توصیه‌شده برای",
            shared: "اغلب SaaS‌ها",
            schemaPer: "بازار میانی",
            dbPer: "سازمانی",
          },
        ],
      },
    ...
    },
    {
      ...
      role: "user",
      content:
        "می‌توانی یک نمودار از معیارهای عملکرد کوئری در این استراتژی‌ها به من نشان دهی؟",
      type: "text",
      createdAt: h(0.4),
    },
    {
      ...
      role: "assistant",
      content:
        "این نتایج بنچمارک از یک شبیه‌سازی ۱۰۰ هزار مستأجری است (کوئری در ثانیه، تأخیر p99 بر حسب میلی‌ثانیه):",
      type: "chart",
      chartContent: {
        type: "bar",
        ...
        data: [
          ...
          {
            strategy: "اسکیما به‌ازای هر مستأجر",
            qps: 11200,
            p99_ms: 8,
            setup_days: 14,
          },
          {
            strategy: "پایگاه داده به‌ازای هر مستأجر",
            qps: 12800,
            p99_ms: 6,
            setup_days: 45,
          },
