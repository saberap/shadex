...
const suggestions = [
  {
    ...
    title: "تحلیل داده",
    prompt:
      "این مجموعه‌داده را تحلیل کن و بینش‌های کلیدی، روندها و توصیه‌های عملی ارائه بده.",
  },
  {
    icon: Image,
    title: "تولید تصویر",
  ...
  },
  {
    ...
    title: "نوشتن کد",
    prompt:
      "یک تابع TypeScript تمیز و آماده تولید با مدیریت خطای مناسب و تایپ‌ها بنویس.",
  },
  {
    icon: Brain,
    title: "طوفان فکری",
    prompt:
      "۱۰ ایده خلاقانه و نوآورانه برای بهبود تعامل کاربر در یک محصول SaaS ارائه بده.",
  },
  {
    icon: Database,
    title: "ساخت کوئری SQL",
    prompt:
      "یک کوئری SQL بهینه با راهنمایی‌های ایندکس‌گذاری مناسب برای کوئری روی یک مجموعه‌داده بزرگ بنویس.",
  },
  {
    icon: FileSearch,
