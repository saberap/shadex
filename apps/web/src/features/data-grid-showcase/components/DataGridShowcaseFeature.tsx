...
const items: ShowcaseItem[] = [
  ...
  },
  {
    ...
    description: "مرتب‌سازی چندستونی با نشانه بصری ظریف هنگام هاور روی ستون.",
  ...
  },
  {
    ...
    description: "فیلترهای متنی، انتخابی و تاریخ یکپارچه در سرستون هر ستون.",
  ...
  },
  {
    ...
    label: "سمت سرور",
    title: "حالت سمت سرور",
    description: "متصل به /api/customers با صفحه‌بندی، مرتب‌سازی و فیلتر دستی.",
